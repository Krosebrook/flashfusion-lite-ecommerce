...
```bash
git remote add encore encore://flashfusion-lite-ecommerce-gmri
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/flashfusion-lite-ecommerce-gmri/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/flashfusion-lite-ecommerce-gmri/settings/integrations/github)
